...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.H3(f"{count_ok}", style={'color': '#2ECC71', 'fontFamily': 'Roboto'}),
            html.P("CELDAS OK", style={'fontFamily': 'Open Sans', 'color': '#2C3E50'})
        ], className="card"),
        
        html.Div([
            html.H3(f"{count_sobrecargada}", style={'color': '#E74C3C', 'fontFamily': 'Roboto'}),
            html.P("CELDAS SOBRECARGADAS", style={'fontFamily': 'Open Sans', 'color': '#2C3E50'})
        ], className="card"),
        
        html.Div([
            html.H3(f"{count_subutilizada}", style={'color': '#F39C12', 'fontFamily': 'Roboto'}),
            html.P("CELDAS SUBUTILIZADAS", style={'fontFamily': 'Open Sans', 'color': '#2C3E50'})
        ], className="card"),
        
        html.Div([
            html.H3(f"{count_total}", style={'color': '#4A90E2', 'fontFamily': 'Roboto'}),
